...
filterPhyla <-  c("Chloroflexi","Cyanobacteria", "Fibrobacterota", "Firmicutes", "Planctomycetota", "Gemmatimonadota", "Nitrospirota")
...
keepTaxa <-  rownames(prevdf_rare1)[(prevdf_rare1$Prevalence >= prevalence_threshold)]
