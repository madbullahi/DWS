...
```{r}
# Assuming you have already run your PERMANOVA and have your distance matrix (wunifrac_dist)
# and your sample data (sample_data)

# Perform pairwise comparisons for Day
pairwise_day <- pairwise.perm.manova(resp = wunifrac_dist, 
                                     fact = sample_data$Day, 
                                     nperm = 999,
                                     p.method = "bonferroni")

# Perform pairwise comparisons for Genotype
pairwise_genotype <- pairwise.perm.manova(resp = wunifrac_dist, 
...
pheatmap(heatmap_matrix,
         ...
         main = "Genera Abundance Across Treatment and Days",
         fontsize = 10,
         cellwidth = 15,
         cellheight = 10,
         fontsize_row = 8,
