...
anova(Atr_reff_lme) # it gives a summary of the model.

tidy_Atr_reff <- tidy(Atr_reff_lme) # tidies the summary from the anova.

write.csv(tidy_Atr_reff,'Atr_reff.csv') # export the anova summary as a csv file.
```
...
anova(meso_ano) # it gives a summary of the model.
...
tidy_meso <- tidy(meso_ano) # tidies the summary from the anova.

write.csv(tidy_meso,'meso_raw.csv') # export the anova summary as a csv file.
```
...
tidy_meso_re <- tidy(meso_re) # tidies the summary from the anova.

write.csv(tidy_meso_re,'meso_reff.csv') # export the anova summary as a csv file.
```
